...
export const courses = [
    ...
    {
      code: "EECS 3401",
      name: "Introduction to Artificial Intelligence and Logic Programming",
      desc:
    ...
    {
      code: "EECS 3214",
      name: "Computer Network Protocols and Applications",
      desc:
    ...
    },
    {
      ...
      desc:
        "Amortized and worst-case analysis of data structures. Data structuring paradigms: self-adjustment and persistence. Lists: self-adjustment with the move-to-front heuristic. Search trees: Red-Black trees, BST. Heaps: skew heaps, Fibonacci heaps. Union-find trees. Link-and-cut trees. Multidimensional data structures and dynamization.",
    },
    {
      code: "EECS 4404",
    ...
    },
    {
      ...
      desc:
        "This course introduces the fundamentals of big data storage, management, and processing systems, highlighting the need for distributed and fault-tolerant solutions due to the volume, velocity, and variety of modern datasets. It covers theoretical concepts and provides practical experience with exemplary technologies and recent research, exploring topics like distributed frameworks, MapReduce, various NoSQL databases (column, key-value, document, graph), and stream processing.",
    },
    {
      code: "EECS 4413",
      name: "Building E-Commerce Systems",
      desc:
        "A study of the technical infrastructure that underlies E-Commerce on the Internet. The foundational concepts are presented through a series of projects that use an industrial-strength framework on the server side, standard-compliant technologies on the client side, and a variety of messaging protocols on the network side. Best practices, security concerns, and performance issues are emphasized throughout.",
    },
  ];
